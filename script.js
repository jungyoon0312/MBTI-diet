const mbtiData = {
  ...
  ISFJ: {
    ...
    img: "https://cdn-icons-png.flaticon.com/512/616/616408.png" // 펭귄 (부엉이와 동일, 필요시 교체)
  },
  ESTJ: {
    tip: "체계적인 계획과 기록이 큰 도움이 돼요.",
    reason: "실용적이고 조직적인 ESTJ는 구체적인 계획과 체크리스트가 동기부여에 좋아요.",
    img: "https://cdn-icons-png.flaticon.com/512/616/616408.png" // 늑대 (부엉이와 동일, 필요시 교체)
  },
  ESFJ: {
    tip: "함께하는 다이어트 모임이 큰 힘이 될 수 있어요.",
    reason: "사교적이고 배려심 많은 ESFJ는 주변과 함께할 때 더 힘을 얻어요.",
    img: "https://cdn-icons-png.flaticon.com/512/616/616408.png" // 박쥐 (부엉이와 동일, 필요시 교체)
  },
  ISTP: {
    tip: "혼자만의 시간에 집중해서 운동해보세요.",
    reason: "독립적이고 실용적인 ISTP는 혼자 집중할 때 효율이 높아요.",
    img: "https://cdn-icons-png.flaticon.com/512/616/616408.png" // 까마귀 (부엉이와 동일, 필요시 교체)
  },
  ISFP: {
    tip: "자연과 함께하는 활동이 잘 맞아요.",
    reason: "감각적이고 자유로운 ISFP는 자연 속에서 활동할 때 스트레스를 줄어요.",
    img: "https://cdn-icons-png.flaticon.com/512/616/616408.png" // 표범 (부엉이와 동일, 필요시 교체)
  },
  ESTP: {
    tip: "즉각적인 변화를 느낄 수 있는 HIIT 운동 추천!",
    reason: "에너지 넘치고 즉흥적인 ESTP는 빠른 변화를 체감할 때 동기부여가 돼요.",
    img: "https://cdn-icons-png.flaticon.com/512/616/616408.png" // 치타 (부엉이와 동일, 필요시 교체)
  },
  ESFP: {
    tip: "친구와 함께하는 운동이 잘 맞아요!",
    reason: "활발하고 사교적인 ESFP는 함께 즐길 때 더 오래 실천할 수 있어요.",
    img: "https://cdn-icons-png.flaticon.com/512/616/616408.png" // 앵무새 (부엉이와 동일, 필요시 교체)
  }
};
...
document.getElementById("showBtn").addEventListener("click", function() {
  ...
  if (mbtiData[mbti]) {
    ...
    imgBox.innerHTML = `<img src="${mbtiData[mbti].img}" alt="${mbti}" style="width:90px; height:auto; margin-top:10px;">`;
  } else {
    tipBox.textContent = "";
